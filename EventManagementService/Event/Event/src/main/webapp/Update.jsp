...
if (request.getParameter("EventID") != null) 
 ...
 String stsMsg = itemObj.Update(request.getParameter("EventID"), 
...
<body>
        ...
        <div class="aa">
            ...
            <br>
        <h1 class="h1">Update Event Information</h1>
      
        <div class="bb">
        <p>Event ID:</p>
      <input type="text" name="EventID" class="no-outline" placeholder="Enter Category">
      <br>
      <p>Category:</p>
